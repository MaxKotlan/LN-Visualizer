    ...
    implements OnChanges, OnInit
{
    ...
    @Input() colors: Uint8Array | null = new Uint8Array([]);
    ...
    private colorData: THREE.BufferAttribute = new THREE.BufferAttribute(
    ...
    protected generatePointGeometryReal() {
        this.geometry.setFromPoints(this.shouldRender ? this.positions : []).scale(100, 100, 100);
