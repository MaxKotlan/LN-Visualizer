...
@Component({
    selector: 'app-active-channel-scripts',
    templateUrl: './active-channel-scripts.component.html',
    styleUrls: ['./active-channel-scripts.component.scss'],
})
export class ActiveChannelScriptsComponent {
